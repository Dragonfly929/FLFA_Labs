...
public class CFGtoCNFConverter {
    ...
    private static final HashMap<String, ArrayList<String>> newProductions = new HashMap<>();
    private static final HashMap<String, String> newProdLookUp = new HashMap<>();
    private static int count = 0;

    public CFGtoCNFConverter(Grammar grammar) {
    ...
    public static void convertToChomskyNormalForm() {
        ...
        for (String productionLeft : grammar.getProductions().keySet()) {
            ...
            productionList.replaceAll(CFGtoCNFConverter::groupProductions);
        }
    ...
    private static String groupProductions(String prod) {
        ...
        while (prod.length() - xCount > 2) {
            ...
            if (newProdLookUp.containsKey(newGroupStr)) {
                ...
                newProductions.put(newLP, new ArrayList<>(List.of(newGroupStr)));
